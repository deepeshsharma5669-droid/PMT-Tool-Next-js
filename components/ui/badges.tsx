...
const tones: Record<string,string> = { ACTIVE:'success',COMPLETED:'success',APPROVED:'success',RESOLVED:'success',IN_PROGRESS:'info',CLIENT_REVIEW:'info',IN_REVIEW:'purple',CLIENT_DECISION:'warning',CLIENT_REWORK:'warning',CHANGES_REQUESTED:'warning',CHANGES_REQUIRED:'danger',OVERDUE:'danger',DROPPED:'danger',REJECTED:'danger',CANCELLED:'neutral',ON_HOLD:'neutral',ARCHIVED:'neutral',PENDING:'neutral',TODO:'neutral',INACTIVE:'neutral' }
